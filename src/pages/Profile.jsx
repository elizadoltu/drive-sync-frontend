              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCarFormData({ ...carFormData, gpsId: e.target.value })
                    }
                    className="w-full p-2 border rounded-md"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCarFormData({
                        ...carFormData,
                        averageFuelConsumption: e.target.value,
                      })
                    }
                    required
                    className="w-full p-2 border rounded-md"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCarFormData({
                        ...carFormData,
                        averageDistanceMade: e.target.value,
                      })
                    }
                    required
                    className="w-full p-2 border rounded-md"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEnrichedCarFormData({
                        ...enrichedCarFormData,
                        co2_emission_rate: e.target.value,
                      })
                    }
                    className="w-full p-2 border rounded-md"
                  />
